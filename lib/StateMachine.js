...
class StateMachine {
    ...
    recieveReturnKey(){
        //custom method - called when the game scene recieved an ENTER keypress from textInput.
        //calls the current state's submit method.
        console.log("in fsm return")
        this.possibleStates[this.state].submit(...this.stateArgs)
    }
}
...
class State {
    ...
    submit() {
        // this code happens when the game scene's listener hears an ENTER keypress.
    }
}